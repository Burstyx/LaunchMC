...
export const localInstancesPath = instancesPath + "/locals"
export const serversInstancesPath = instancesPath + "/servers"
...
export const forgeVersionsStatuesManifest = "https://files.minecraftforge.net/net/minecraftforge/forge/promotions_slim.json"
